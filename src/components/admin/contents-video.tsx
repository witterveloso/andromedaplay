      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={(e) => { e.preventDefault(); save.mutate(); }} className="space-y-4">
          ...
          <div className="rounded-md border p-3 space-y-3 bg-muted/20">
            <div className="space-y-1.5">
              <Label>
                {videoProvider === "external_link" ? "URL do link externo" : "URL do vídeo"}
              </Label>
              <Input
                type="url"
                placeholder={
                  videoProvider === "external_link"
                    ? "https://chatgpt.com/g/… ou qualquer link"
              ...
              <p className="text-xs text-muted-foreground">
                {videoProvider === "external_link"
                  ? "O aluno verá um botão “Acessar conteúdo” que abre este link em uma nova aba."
                  : "Cole o link do vídeo. O player será gerado automaticamente."}
              </p>
            </div>
          ...
          <div className="space-y-3 rounded-md border p-3">
            ...
            {!editing ? (
              <p className="text-xs text-muted-foreground">
                Salve a aula primeiro para anexar materiais (PDF, imagem, arquivo ou link externo).
              </p>
            ) : (
              <>
