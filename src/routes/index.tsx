...
function HomePage() {
  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-3xl flex-col items-center justify-center px-6 py-8 md:px-10">
        {/* Top bar */}
        <header className="absolute top-0 left-0 w-full px-6 py-6 md:px-10">
          <AndromedaLogo />
        </header>
        ...
        <section className="flex w-full flex-col items-center gap-8 text-center">
          ...
          <h1 className="text-balance text-3xl font-semibold leading-[1.1] tracking-tight text-soft-white sm:text-4xl md:text-5xl">
          ...
          <div className="mt-2 flex w-full flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              to="/login"
              className="inline-flex h-12 items-center justify-center rounded-md px-8 text-sm font-semibold text-soft-white transition hover:opacity-95 sm:min-w-[160px]"
              style={{
            ...
            <Link
              to="/login"
              search={{ mode: "signup" }}
              className="inline-flex h-12 items-center justify-center rounded-md border border-white/15 bg-white/[0.04] px-8 text-sm font-semibold text-soft-white backdrop-blur-md transition hover:bg-white/[0.08] sm:min-w-[160px]"
            >
              Criar conta
            </Link>
          </div>
        ...
        <footer className="absolute bottom-0 w-full pb-4 text-center text-xs text-stellar-silver/50">
